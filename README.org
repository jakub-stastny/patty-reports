...
~POST /api/v1/reports/staff-plan~

*** Minimal request

  Only required properties are provided.

#+begin_src json :tangle data/requests/staff-plan/01-base.json :mkdirp yes
...
#+begin_src json :tangle data/requests/staff-plans/20-staff-plans-no-bizfn.json :mkdirp yes
  {
    "projections-start-date": 1735687848739,
    "staff": [
      {
...
#+begin_src json :tangle data/requests/staff-plans/21-staff-plans-one.json :mkdirp yes
  {
    "projections-start-date": 1735687848739,
    "staff": [
      {
...
#+begin_src json :tangle data/requests/staff-plans/22-staff-plans-multi.json :mkdirp yes
  {
    "projections-start-date": 1735687848739,
    "staff": [
      {
...
#+begin_src json :tangle data/requests/sales-forecast/01-basic.json :mkdirp yes
  {}
#+end_src
