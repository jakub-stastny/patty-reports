...
#+begin_src json :tangle requests/21-staff-plans-one.json :mkdirp yes
  {
    "projections-start-date": 1735687848739,
    "staff": [
      {
...
#+begin_src json :tangle requests/22-staff-plans-multi.json :mkdirp yes
  {
    "projections-start-date": 1735687848739,
    "staff": [
      {
...
#+begin_src json :tangle requests/30-sales-forecast.json :mkdirp yes
  {}
#+end_src
