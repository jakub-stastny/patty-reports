...
(define generate-options-validator [fn-name field-name options-map]
  (jsa/assertions fn-name field-name [keyword?] "field-name must be a keyword")
  (jsa/assertions fn-name options-map [map?] "options-map must be a map")
